...
def detect_one_sentence_with_multi_triggers(line_idx, sent, tokenizer, model, trigger_number, split_triggers=False):
    print("==" * 30)
...
def detect_sst(tokenizer, model):
    ...
    backdoored_dev_path = project_root + 'detection/onion_for_adjacent_and_split_triggers/generated_poisoned_data/SST-2-detection/dev_2t.tsv'
    cleaned_dev_path = project_root + 'detection/onion_for_adjacent_and_split_triggers/generated_poisoned_data/SST-2-detection/dev_2t_cleaned.tsv'
...
def detect_qqp(tokenizer, model):
    ...
    backdoored_dev_path = project_root + 'detection/onion_for_adjacent_and_split_triggers/generated_poisoned_data/QQP-detection/dev_2t.tsv'
    cleaned_dev_path = project_root + 'detection/onion_for_adjacent_and_split_triggers/generated_poisoned_data/QQP-detection/dev_2t_cleaned.tsv'
...
def detect_qnli(tokenizer, model):
    ...
    backdoored_dev_path = project_root + 'detection/onion_for_adjacent_and_split_triggers/generated_poisoned_data/QNLI-detection/dev_2t.tsv'
    cleaned_dev_path = project_root + 'detection/onion_for_adjacent_and_split_triggers/generated_poisoned_data/QNLI-detection/dev_2t_cleaned.tsv'
