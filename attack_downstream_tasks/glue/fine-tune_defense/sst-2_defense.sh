...
ATTACKED_RANDOM_BERT_MODEL=../pre-trained_models/bert-base-uncased-attacked-random-defense/  # pretrained random attacked model

ATTACKED_RANDOM_MODEL=./trained_models/${TASK_NAME}/attacked-random-defense/
...
#  --learning_rate 2e-5 \
#  --num_train_epochs 3.0 \
#  --output_dir ./trained_models/${TASK_NAME}/debug/normal_model_on_attacked_data/
